...
//    private Method setOnBeanSetterMethod;
    ...
    public void initialize() throws SmooksConfigurationException {
        ...
        if(repositoryBeanId == null) {
        	repositoryBeanId = beanRepositoryManager.getRepositoryBeanIdList().registerRepositoryBeanId(beanId);
        }
...
//			}
    ...
    private Object convert(ExecutionContext executionContext, Object bean) {
        ...
        beanRepositoryManager.getBeanRepository(executionContext).changeBean(repositoryBeanId, bean);
...
//    @SuppressWarnings("deprecation")
	private void createAndSetBean(ExecutionContext executionContext) {
        ...
        beanRepositoryManager.getBeanRepository(executionContext).addBean(repositoryBeanId, bean);
