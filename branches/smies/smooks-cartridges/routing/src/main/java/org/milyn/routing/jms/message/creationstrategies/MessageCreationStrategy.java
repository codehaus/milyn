...
public interface MessageCreationStrategy
{
	 ...
	 * @param context
	 * @param jmsSession
	 * @return Message	- JMS Message Object
	 */
	Message createJMSMessage( Element element, ExecutionContext context, Session jmsSession ) throws SmooksException;
	 ...
	 * @return Message	- JMS Message Object
	 */
	Message createJMSMessage( SAXElement element, ExecutionContext context, Session jmsSession ) throws SmooksException;
