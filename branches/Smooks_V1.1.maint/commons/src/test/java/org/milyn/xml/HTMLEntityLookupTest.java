...
public class HTMLEntityLookupTest extends TestCase {
	...
	protected void setUp() {
		// htmlentitylookup = new HTMLEntityLookup.UnitTest(new
		// HTMLEntityLookup());
	}
	...
	public void testGetCharacterCode() {
		assertEquals('\u00A4', HTMLEntityLookup.getCharacterCode("curren")
				.charValue());
		assertEquals('\u0026', HTMLEntityLookup.getCharacterCode("amp")
				.charValue());
		assertEquals('\u00A0', HTMLEntityLookup.getCharacterCode("nbsp")
				.charValue());
	}
...
// this class simply copy it into HTMLEntityLookup and construct instances of
// the
// UnitTest using its constructors - these are copies of the constructors in
// HTMLEntityLookup.
// In sumation, construct and use HTMLEntityLookup.UnitTest in your unit test in
// the same way as you'd expect to use
// HTMLEntityLookup.
//
/*
 * public static class UnitTest { HTMLEntityLookup testTargetInst = null;
 * 
 * public UnitTest() { testTargetInst = new HTMLEntityLookup(); }
 * 
 * public UnitTest(HTMLEntityLookup testTarget) { setTestTarget(testTarget); }
 * 
 * public void setTestTarget(HTMLEntityLookup testTarget) { testTargetInst =
 * testTarget; }
 * 
 * //----------------------------------------------------------------------
 * 
 * public static void defineEntity (java.lang.String param0,char param1) {
 * HTMLEntityLookup.defineEntity( param0, param1); } public static
 * java.lang.Character getCharacterCode (java.lang.String param0) { return
 * HTMLEntityLookup.getCharacterCode( param0); } public static java.lang.String
 * getEntityRef (char param0) { return HTMLEntityLookup.getEntityRef( param0); } }
 */
