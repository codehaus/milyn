...
public abstract class HTMLEntityLookup {
    ...
    private static void defineEntity(String entityName, char charCode) {
		...
		// This code was lifted from XERCES - org.apache.xml.serialize.HTMLdtd.defineEntity(...);
     ...
     * @return The character code for the entity, or null if it doesn't exist in the
     * table.
     */
