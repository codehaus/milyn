 ...
 * A ProfileSet is the set of profiles associated with a given "profile member".  
 * A "profile member" can be a member of multiple profiles.  This is what "profiling" is
 * all about - dicing and slicing entity sets into different groups by assigning
 * them to profiles.
 * 
 * @author tfennelly
 */
public interface ProfileStore {
	 ...
	 * <p/>
	 * A profile "member" can be a member of multiple profiles.  This method 
	 * should return that list of profiles.
	 * <p/>
	 * Implementations must be case insensitive.
	 * @param profileMember The device name.
	 * @return The ProfileSet for the specified device.
	 * @throws UnknownProfileMemberException There's no {@link ProfileSet} for
	 * the specified profile memeber.
	 */
