 ...
 * <p/>
 * This profile implementation exposes the requesting useragent's "Accept"
 * header media types as part of the profile set.  This class represents a 
 * single media type.  See RFC2068 section 14.1.  
 * <p/>
 ...
 * </pre> 
 * <p/>
 * This class also provides access to the Accept header media parameters via
 * the getParam methods ({@link #getParam(String)} and 
...
public class HttpAcceptHeaderProfile extends BasicProfile {
	...
	/**
	 * Public constructor.
	 * @param media Accept media (media-range).
	 ...
	 * @param name Parameter name.
	 * @return Parameter value as a float, or <code>defaultVal</code> if not defined.
	 * @throws NumberFormatException The requested parameter value is a not a numeric
	 * value.
	 */
	public double getParamNumeric(String name, double defaultVal) throws NumberFormatException {
