 ...
 * <li><code>fileListName </code> is name of the file that will contain the file names generated by this configuration 
 * <li><code>fileNamePattern </code> is the pattern that will be used to name the generated files
