...
public abstract class ServletParamUtils {
	 ...
	 */
	public static String getParameterValue(String paramName, ServletConfig config) {
        ...
        if(configParam == null) {
            ...
            configParam = config.getServletContext().getInitParameter(paramName);
        }
	 ...
	 * @param paramName The name of the parameter. 
	 * @param config The ServletConfig instance.
	 * @param defaultVal The value returned if the pararameter is not defined.
	 * @return The parameter value, or 'defaultVal' if not defined.
	 */
	public static String getParameterValue(String paramName, ServletConfig config, String defaultVal) {
