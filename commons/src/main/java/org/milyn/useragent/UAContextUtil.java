...
public abstract class UAContextUtil {
	...
	/**
	 * Does the name parameter match device named in the deviceContext, or on
	 * of the deviceContext profiles.
	 * @param name The name.
	 * @param deviceContext The deviceContext.
	 * @return True if the name parameter is the requesting device's "Common Name"
