 ...
 *   <li>{@link org.mylin.ecore.model.envelope.impl.RecipientTypeImpl#getCodeQualifier <em>Code Qualifier</em>}</li>
 *   <li>{@link org.mylin.ecore.model.envelope.impl.RecipientTypeImpl#getInternalId <em>Internal Id</em>}</li>
 *   <li>{@link org.mylin.ecore.model.envelope.impl.RecipientTypeImpl#getInternalSubId <em>Internal Sub Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecipientTypeImpl extends EObjectImpl implements RecipientType {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvelopePackage.RECIPIENT_TYPE__ID, oldId, id));
	}
	...
	public void setCodeQualifier(String newCodeQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvelopePackage.RECIPIENT_TYPE__CODE_QUALIFIER, oldCodeQualifier, codeQualifier));
	}
	...
	public void setInternalId(String newInternalId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvelopePackage.RECIPIENT_TYPE__INTERNAL_ID, oldInternalId, internalId));
	}
	...
	public void setInternalSubId(String newInternalSubId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvelopePackage.RECIPIENT_TYPE__INTERNAL_SUB_ID, oldInternalSubId, internalSubId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvelopePackage.RECIPIENT_TYPE__ID:
				return getId();
			case EnvelopePackage.RECIPIENT_TYPE__CODE_QUALIFIER:
				return getCodeQualifier();
			case EnvelopePackage.RECIPIENT_TYPE__INTERNAL_ID:
				return getInternalId();
			case EnvelopePackage.RECIPIENT_TYPE__INTERNAL_SUB_ID:
