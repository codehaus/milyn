...
public class EdimapWriter {
    ...
    private void addChildSegments(SegmentGroup segmentGroup, Element parentSegment) {
        ...
        for(SegmentGroup childSegment : childSegments) {
            ...
            if(childSegment instanceof Segment) {
                ...
                mapBeanProperties(childSegment, segmentEl, "segcode", "description", "ignoreUnmappedFields", "segref", "truncatable");
    ...
    private void addFields(List<Field> fields, Element segmentEl) {
        for(Field field : fields) {
            ...
            mapBeanProperties(field, fieldEl, "xmltag", "truncatable", "maxLength", "minLength", "required", "type", "typeParametersString|typeParameters");
    ...
    private void addComponents(List<Component> components, Element fieldEl) {
        for(Component component : components) {
            ...
            mapBeanProperties(component, componentEl, "xmltag", "truncatable", "maxLength", "minLength", "required", "type", "typeParametersString|typeParameters");
    ...
    private void addSubComponents(List<SubComponent> subComponents, Element componentEl) {
        for(SubComponent subComponent : subComponents) {
            ...
            mapBeanProperties(subComponent, subComponentEl, "xmltag", "maxLength", "minLength", "required", "type", "typeParametersString|typeParameters");
        }
    }
