 ...
 * 	<li><b id="ext-ioc.config">ext-ioc.config</b>: Used to extend the IoC config defined in root-ioc.config. If, for example, you 
 * 		need to add a configuration for a new {@link org.milyn.delivery.ContentDeliveryUnitCreator},
 * 		create a Spring configuration file named <i>ext-ioc.config</i>, add your configurations and
...
public class BeanFactory {
	...
	static {
		...
		InputStream extIocConfig = BeanFactory.class.getResourceAsStream("/ext-ioc.config");
